...
def get_loadstmt_for_stock(start_s_i_id):
...
def get_loadstmt_for_customer_history(d_id):
    random.seed(d_id)
...
def get_loadstmt_for_orders_neworders_orderline(d_id):
    random.seed(d_id)

...
while True:
    try: 
        pool = CustomedThreadedConnectionPool(max_txn_cnt=30, minconn=50, maxconn=50, host="{}-db".format(config.peer_name), port="5432", dbname="postgres", user="dejima", password="barfoo")
        break

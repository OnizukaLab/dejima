...
while True:
    try: 
        pool = CustomedThreadedConnectionPool(max_txn_cnt=30, minconn=30, maxconn=100, host="{}-db".format(config.peer_name), port="5432", dbname="postgres", user="dejima", password="barfoo")
        break

...
FROM (SELECT d1_4_a22_0.COL0 AS COL0, d1_4_a22_0.COL1 AS COL1, d1_4_a22_0.COL2 AS COL2, d1_4_a22_0.COL3 AS COL3, d1_4_a22_0.COL4 AS COL4, d1_4_a22_0.COL5 AS COL5, d1_4_a22_0.COL6 AS COL6, d1_4_a22_0.COL7 AS COL7, d1_4_a22_0.COL8 AS COL8, d1_4_a22_0.COL9 AS COL9, d1_4_a22_0.COL10 AS COL10, d1_4_a22_0.COL11 AS COL11, d1_4_a22_0.COL12 AS COL12, d1_4_a22_0.COL13 AS COL13, d1_4_a22_0.COL14 AS COL14, d1_4_a22_0.COL15 AS COL15, d1_4_a22_0.COL16 AS COL16, d1_4_a22_0.COL17 AS COL17, d1_4_a22_0.COL18 AS COL18, d1_4_a22_0.COL19 AS COL19, d1_4_a22_0.COL20 AS COL20, d1_4_a22_0.COL21 AS COL21 
...
WHERE bt_a22_0.COND1  <  80 ) AS d1_4_a22_0  ) AS __dummy__;
...
BEGIN
    ...
    THEN
        ...
        CREATE TEMPORARY TABLE IF NOT EXISTS __tmp_delta_ins_bt_for_d1_4 ( LIKE public.bt ) WITH OIDS ON COMMIT DELETE ROWS;
        CREATE TEMPORARY TABLE IF NOT EXISTS __tmp_delta_del_bt_for_d1_4 ( LIKE public.bt ) WITH OIDS ON COMMIT DELETE ROWS;
...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM information_schema.tables WHERE table_name = 'd1_4_delta_action_flag') THEN
        ...
        END IF;
        DELETE FROM __tmp_delta_del_bt_for_d1_4 WHERE ROW(ID,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = NEW;
        INSERT INTO __tmp_delta_ins_bt_for_d1_4 SELECT (NEW).*; 
        ELSIF TG_OP = 'UPDATE' THEN
        IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
            RAISE check_violation USING MESSAGE = 'Invalid update: null value is not accepted';
        END IF;
        DELETE FROM __tmp_delta_ins_bt_for_d1_4 WHERE ROW(ID,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = OLD;
...
FROM (SELECT part_ins_d1_4_a22_0.COL0 AS COL0, part_ins_d1_4_a22_0.COL1 AS COL1, part_ins_d1_4_a22_0.COL2 AS COL2, part_ins_d1_4_a22_0.COL3 AS COL3, part_ins_d1_4_a22_0.COL4 AS COL4, part_ins_d1_4_a22_0.COL5 AS COL5, part_ins_d1_4_a22_0.COL6 AS COL6, part_ins_d1_4_a22_0.COL7 AS COL7, part_ins_d1_4_a22_0.COL8 AS COL8, part_ins_d1_4_a22_0.COL9 AS COL9, part_ins_d1_4_a22_0.COL10 AS COL10, part_ins_d1_4_a22_0.COL11 AS COL11, part_ins_d1_4_a22_0.COL12 AS COL12, part_ins_d1_4_a22_0.COL13 AS COL13, part_ins_d1_4_a22_0.COL14 AS COL14, part_ins_d1_4_a22_0.COL15 AS COL15, part_ins_d1_4_a22_0.COL16 AS COL16, part_ins_d1_4_a22_0.COL17 AS COL17, part_ins_d1_4_a22_0.COL18 AS COL18, part_ins_d1_4_a22_0.COL19 AS COL19, part_ins_d1_4_a22_0.COL20 AS COL20, part_ins_d1_4_a22_0.COL21 AS COL21 
...
FROM (SELECT __tmp_delta_ins_bt_for_d1_4_ar_a22_0.ID AS COL0, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL1 AS COL1, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL2 AS COL2, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL3 AS COL3, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL4 AS COL4, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL5 AS COL5, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL6 AS COL6, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL7 AS COL7, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL8 AS COL8, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL9 AS COL9, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COL10 AS COL10, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.LINEAGE AS COL11, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND1 AS COL12, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND2 AS COL13, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND3 AS COL14, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND4 AS COL15, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND5 AS COL16, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND6 AS COL17, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND7 AS COL18, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND8 AS COL19, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND9 AS COL20, __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND10 AS COL21 
FROM __tmp_delta_ins_bt_for_d1_4_ar AS __tmp_delta_ins_bt_for_d1_4_ar_a22_0 
WHERE __tmp_delta_ins_bt_for_d1_4_ar_a22_0.COND1  <  80 ) AS p_0_a22_0  ) AS part_ins_d1_4_a22_0  ) AS __dummy__) AS tbl;
...
FROM (SELECT part_del_d1_4_a22_0.COL0 AS COL0, part_del_d1_4_a22_0.COL1 AS COL1, part_del_d1_4_a22_0.COL2 AS COL2, part_del_d1_4_a22_0.COL3 AS COL3, part_del_d1_4_a22_0.COL4 AS COL4, part_del_d1_4_a22_0.COL5 AS COL5, part_del_d1_4_a22_0.COL6 AS COL6, part_del_d1_4_a22_0.COL7 AS COL7, part_del_d1_4_a22_0.COL8 AS COL8, part_del_d1_4_a22_0.COL9 AS COL9, part_del_d1_4_a22_0.COL10 AS COL10, part_del_d1_4_a22_0.COL11 AS COL11, part_del_d1_4_a22_0.COL12 AS COL12, part_del_d1_4_a22_0.COL13 AS COL13, part_del_d1_4_a22_0.COL14 AS COL14, part_del_d1_4_a22_0.COL15 AS COL15, part_del_d1_4_a22_0.COL16 AS COL16, part_del_d1_4_a22_0.COL17 AS COL17, part_del_d1_4_a22_0.COL18 AS COL18, part_del_d1_4_a22_0.COL19 AS COL19, part_del_d1_4_a22_0.COL20 AS COL20, part_del_d1_4_a22_0.COL21 AS COL21 
FROM (SELECT p_0_a22_0.COL0 AS COL0, p_0_a22_0.COL1 AS COL1, p_0_a22_0.COL2 AS COL2, p_0_a22_0.COL3 AS COL3, p_0_a22_0.COL4 AS COL4, p_0_a22_0.COL5 AS COL5, p_0_a22_0.COL6 AS COL6, p_0_a22_0.COL7 AS COL7, p_0_a22_0.COL8 AS COL8, p_0_a22_0.COL9 AS COL9, p_0_a22_0.COL10 AS COL10, p_0_a22_0.COL11 AS COL11, p_0_a22_0.COL12 AS COL12, p_0_a22_0.COL13 AS COL13, p_0_a22_0.COL14 AS COL14, p_0_a22_0.COL15 AS COL15, p_0_a22_0.COL16 AS COL16, p_0_a22_0.COL17 AS COL17, p_0_a22_0.COL18 AS COL18, p_0_a22_0.COL19 AS COL19, p_0_a22_0.COL20 AS COL20, p_0_a22_0.COL21 AS COL21 
FROM (SELECT __tmp_delta_del_bt_for_d1_4_ar_a22_0.ID AS COL0, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL1 AS COL1, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL2 AS COL2, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL3 AS COL3, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL4 AS COL4, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL5 AS COL5, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL6 AS COL6, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL7 AS COL7, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL8 AS COL8, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL9 AS COL9, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COL10 AS COL10, __tmp_delta_del_bt_for_d1_4_ar_a22_0.LINEAGE AS COL11, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND1 AS COL12, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND2 AS COL13, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND3 AS COL14, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND4 AS COL15, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND5 AS COL16, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND6 AS COL17, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND7 AS COL18, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND8 AS COL19, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND9 AS COL20, __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND10 AS COL21 
FROM __tmp_delta_del_bt_for_d1_4_ar AS __tmp_delta_del_bt_for_d1_4_ar_a22_0 
WHERE __tmp_delta_del_bt_for_d1_4_ar_a22_0.COND1  <  80 ) AS p_0_a22_0  ) AS part_del_d1_4_a22_0  ) AS __dummy__) AS tbl;
...
FROM __tmp_delta_del_d1_4_ar AS __tmp_delta_del_d1_4_ar_a22_0, public.bt AS bt_a22_1 
WHERE bt_a22_1.COL7 = __tmp_delta_del_d1_4_ar_a22_0.COL7 AND bt_a22_1.COL5 = __tmp_delta_del_d1_4_ar_a22_0.COL5 AND bt_a22_1.COL2 = __tmp_delta_del_d1_4_ar_a22_0.COL2 AND bt_a22_1.COND10 = __tmp_delta_del_d1_4_ar_a22_0.COND10 AND bt_a22_1.COND5 = __tmp_delta_del_d1_4_ar_a22_0.COND5 AND bt_a22_1.COND7 = __tmp_delta_del_d1_4_ar_a22_0.COND7 AND bt_a22_1.COL6 = __tmp_delta_del_d1_4_ar_a22_0.COL6 AND bt_a22_1.COND1 = __tmp_delta_del_d1_4_ar_a22_0.COND1 AND bt_a22_1.COL1 = __tmp_delta_del_d1_4_ar_a22_0.COL1 AND bt_a22_1.COL3 = __tmp_delta_del_d1_4_ar_a22_0.COL3 AND bt_a22_1.COL8 = __tmp_delta_del_d1_4_ar_a22_0.COL8 AND bt_a22_1.COND4 = __tmp_delta_del_d1_4_ar_a22_0.COND4 AND bt_a22_1.COND8 = __tmp_delta_del_d1_4_ar_a22_0.COND8 AND bt_a22_1.COL9 = __tmp_delta_del_d1_4_ar_a22_0.COL9 AND bt_a22_1.ID = __tmp_delta_del_d1_4_ar_a22_0.ID AND bt_a22_1.COND2 = __tmp_delta_del_d1_4_ar_a22_0.COND2 AND bt_a22_1.COND3 = __tmp_delta_del_d1_4_ar_a22_0.COND3 AND bt_a22_1.COL10 = __tmp_delta_del_d1_4_ar_a22_0.COL10 AND bt_a22_1.COND9 = __tmp_delta_del_d1_4_ar_a22_0.COND9 AND bt_a22_1.COND6 = __tmp_delta_del_d1_4_ar_a22_0.COND6 AND bt_a22_1.LINEAGE = __tmp_delta_del_d1_4_ar_a22_0.LINEAGE AND bt_a22_1.COL4 = __tmp_delta_del_d1_4_ar_a22_0.COL4 AND bt_a22_1.COND1  <  80 ) AS p_0_a22_0  ) AS delta_del_bt_a22_0  ) AS delta_del_bt_extra_alias) AS tbl;
...
FROM (SELECT p_0_a22_0.COL0 AS COL0, p_0_a22_0.COL1 AS COL1, p_0_a22_0.COL2 AS COL2, p_0_a22_0.COL3 AS COL3, p_0_a22_0.COL4 AS COL4, p_0_a22_0.COL5 AS COL5, p_0_a22_0.COL6 AS COL6, p_0_a22_0.COL7 AS COL7, p_0_a22_0.COL8 AS COL8, p_0_a22_0.COL9 AS COL9, p_0_a22_0.COL10 AS COL10, p_0_a22_0.COL11 AS COL11, p_0_a22_0.COL12 AS COL12, p_0_a22_0.COL13 AS COL13, p_0_a22_0.COL14 AS COL14, p_0_a22_0.COL15 AS COL15, p_0_a22_0.COL16 AS COL16, p_0_a22_0.COL17 AS COL17, p_0_a22_0.COL18 AS COL18, p_0_a22_0.COL19 AS COL19, p_0_a22_0.COL20 AS COL20, p_0_a22_0.COL21 AS COL21 
FROM (SELECT __tmp_delta_ins_d1_4_ar_a22_0.ID AS COL0, __tmp_delta_ins_d1_4_ar_a22_0.COL1 AS COL1, __tmp_delta_ins_d1_4_ar_a22_0.COL2 AS COL2, __tmp_delta_ins_d1_4_ar_a22_0.COL3 AS COL3, __tmp_delta_ins_d1_4_ar_a22_0.COL4 AS COL4, __tmp_delta_ins_d1_4_ar_a22_0.COL5 AS COL5, __tmp_delta_ins_d1_4_ar_a22_0.COL6 AS COL6, __tmp_delta_ins_d1_4_ar_a22_0.COL7 AS COL7, __tmp_delta_ins_d1_4_ar_a22_0.COL8 AS COL8, __tmp_delta_ins_d1_4_ar_a22_0.COL9 AS COL9, __tmp_delta_ins_d1_4_ar_a22_0.COL10 AS COL10, __tmp_delta_ins_d1_4_ar_a22_0.LINEAGE AS COL11, __tmp_delta_ins_d1_4_ar_a22_0.COND1 AS COL12, __tmp_delta_ins_d1_4_ar_a22_0.COND2 AS COL13, __tmp_delta_ins_d1_4_ar_a22_0.COND3 AS COL14, __tmp_delta_ins_d1_4_ar_a22_0.COND4 AS COL15, __tmp_delta_ins_d1_4_ar_a22_0.COND5 AS COL16, __tmp_delta_ins_d1_4_ar_a22_0.COND6 AS COL17, __tmp_delta_ins_d1_4_ar_a22_0.COND7 AS COL18, __tmp_delta_ins_d1_4_ar_a22_0.COND8 AS COL19, __tmp_delta_ins_d1_4_ar_a22_0.COND9 AS COL20, __tmp_delta_ins_d1_4_ar_a22_0.COND10 AS COL21 
FROM __tmp_delta_ins_d1_4_ar AS __tmp_delta_ins_d1_4_ar_a22_0 
WHERE __tmp_delta_ins_d1_4_ar_a22_0.COND1  <  80 AND NOT EXISTS ( SELECT * 
FROM public.bt AS bt_a22 
WHERE bt_a22.COND10 = __tmp_delta_ins_d1_4_ar_a22_0.COND10 AND bt_a22.COND9 = __tmp_delta_ins_d1_4_ar_a22_0.COND9 AND bt_a22.COND8 = __tmp_delta_ins_d1_4_ar_a22_0.COND8 AND bt_a22.COND7 = __tmp_delta_ins_d1_4_ar_a22_0.COND7 AND bt_a22.COND6 = __tmp_delta_ins_d1_4_ar_a22_0.COND6 AND bt_a22.COND5 = __tmp_delta_ins_d1_4_ar_a22_0.COND5 AND bt_a22.COND4 = __tmp_delta_ins_d1_4_ar_a22_0.COND4 AND bt_a22.COND3 = __tmp_delta_ins_d1_4_ar_a22_0.COND3 AND bt_a22.COND2 = __tmp_delta_ins_d1_4_ar_a22_0.COND2 AND bt_a22.COND1 = __tmp_delta_ins_d1_4_ar_a22_0.COND1 AND bt_a22.LINEAGE = __tmp_delta_ins_d1_4_ar_a22_0.LINEAGE AND bt_a22.COL10 = __tmp_delta_ins_d1_4_ar_a22_0.COL10 AND bt_a22.COL9 = __tmp_delta_ins_d1_4_ar_a22_0.COL9 AND bt_a22.COL8 = __tmp_delta_ins_d1_4_ar_a22_0.COL8 AND bt_a22.COL7 = __tmp_delta_ins_d1_4_ar_a22_0.COL7 AND bt_a22.COL6 = __tmp_delta_ins_d1_4_ar_a22_0.COL6 AND bt_a22.COL5 = __tmp_delta_ins_d1_4_ar_a22_0.COL5 AND bt_a22.COL4 = __tmp_delta_ins_d1_4_ar_a22_0.COL4 AND bt_a22.COL3 = __tmp_delta_ins_d1_4_ar_a22_0.COL3 AND bt_a22.COL2 = __tmp_delta_ins_d1_4_ar_a22_0.COL2 AND bt_a22.COL1 = __tmp_delta_ins_d1_4_ar_a22_0.COL1 AND bt_a22.ID = __tmp_delta_ins_d1_4_ar_a22_0.ID ) ) AS p_0_a22_0  ) AS delta_ins_bt_a22_0  ) AS delta_ins_bt_extra_alias) AS tbl; 
...
AS $$
  ...
  BEGIN
    ...
    THEN
        ...
        CREATE TEMPORARY TABLE IF NOT EXISTS __tmp_delta_ins_d1_4 ( LIKE public.d1_4 ) WITH OIDS ON COMMIT DELETE ROWS;
        ...
        CREATE TEMPORARY TABLE IF NOT EXISTS __tmp_delta_del_d1_4 ( LIKE public.d1_4 ) WITH OIDS ON COMMIT DELETE ROWS;
...
AS $$
  ...
  BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
      ...
      END IF;
      DELETE FROM __tmp_delta_del_d1_4 WHERE ROW(ID,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = NEW;
      INSERT INTO __tmp_delta_ins_d1_4 SELECT (NEW).*; 
    ELSIF TG_OP = 'UPDATE' THEN
      IF (SELECT count(*) FILTER (WHERE j.value = jsonb 'null') FROM  jsonb_each(to_jsonb(NEW)) j) > 0 THEN 
        RAISE check_violation USING MESSAGE = 'Invalid update on view: view does not accept null value';
      END IF;
      DELETE FROM __tmp_delta_ins_d1_4 WHERE ROW(ID,COL1,COL2,COL3,COL4,COL5,COL6,COL7,COL8,COL9,COL10,LINEAGE,COND1,COND2,COND3,COND4,COND5,COND6,COND7,COND8,COND9,COND10) = OLD;
...
CREATE OR REPLACE FUNCTION public.clean_dummy_d1_4 ()
RETURNS TRIGGER
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
  ...
  BEGIN
    xid := (SELECT txid_current());
    DELETE FROM public.__dummy__d1_4_detected_deletions as t where t.txid = xid;
    DELETE FROM public.__dummy__d1_4_detected_insertions as t where t.txid = xid;
    RAISE LOG 'clean __dummy__d1_4_detected_deletions/insertions';
    RETURN NULL;
  END;
$$;

CREATE CONSTRAINT TRIGGER __zzz_clean_d1_4
    AFTER INSERT OR UPDATE OR DELETE ON
    public.bt DEFERRABLE INITIALLY DEFERRED FOR EACH ROW EXECUTE PROCEDURE public.clean_dummy_d1_4();

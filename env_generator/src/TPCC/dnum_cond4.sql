...
WHERE customer_a32_0.C_COND04  <  <border> ) AS dnum_a32_0  ) AS __dummy__;
...
WHERE __tmp_delta_ins_customer_for_dnum_ar_a32_0.C_COND04  <  <border> ) AS p_0_a32_0  ) AS part_ins_dnum_a32_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_del_customer_for_dnum_ar_a32_0.C_COND04  <  <border> ) AS p_0_a32_0  ) AS part_del_dnum_a32_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_ins_dnum_ar_a32_0.C_COND04  <  <border> AND NOT EXISTS ( SELECT * 

...
WHERE bt_a22_0.COND8  <  <border> ) AS dnum_a22_0  ) AS __dummy__;
...
WHERE __tmp_delta_ins_bt_for_dnum_ar_a22_0.COND8  <  <border> ) AS p_0_a22_0  ) AS part_ins_dnum_a22_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_del_bt_for_dnum_ar_a22_0.COND8  <  <border> ) AS p_0_a22_0  ) AS part_del_dnum_a22_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_ins_dnum_ar_a22_0.COND8  <  <border> AND NOT EXISTS ( SELECT * 

...
CREATE TABLE customer (
  ...
  c_lineage varchar(500) NOT NULL,
  c_cond01 int NOT NULL,
  c_cond02 int NOT NULL,
  c_cond03 int NOT NULL,
  c_cond04 int NOT NULL,
  c_cond05 int NOT NULL,
  c_cond06 int NOT NULL,
  c_cond07 int NOT NULL,
  c_cond08 int NOT NULL,
  c_cond09 int NOT NULL,
  c_cond10 int NOT NULL,

...
WHERE bt_a22_0.COND7  <  80 ) AS d1_6_a22_0  ) AS __dummy__;
...
WHERE __tmp_delta_ins_bt_for_d1_6_ar_a22_0.COND7  <  80 ) AS p_0_a22_0  ) AS part_ins_d1_6_a22_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_del_bt_for_d1_6_ar_a22_0.COND7  <  80 ) AS p_0_a22_0  ) AS part_del_d1_6_a22_0  ) AS __dummy__) AS tbl;
...
WHERE __tmp_delta_ins_d1_6_ar_a22_0.COND7  <  80 AND NOT EXISTS ( SELECT * 
